...
namespace BlobGame
{
  public class NetworkManager : Mirror.NetworkManager
  {
    ...
    {
      return singleton.spawnPrefabs.Find((go) => String.Equals(go.name, name));
    }

    public delegate void OnServerOrClientStart();
    public static event OnServerOrClientStart onServerOrClientStart;
    ...
    {
      // Debug.Log($"NetworkManager.LateUpdate()");
      base.LateUpdate();
    }
    ...
    {
      Debug.Log($"NetworkManager.ConfigureHeadlessFrameRate()");
    ...
    {
      Debug.Log($"NetworkManager.OnServerChangeScene()");
    }
    ...
    {
      Debug.Log($"NetworkManager.OnClientChangeScene()");
    }
    ...
    public Mirror.UnityEventNetworkConnection OnServerConnected = new Mirror.UnityEventNetworkConnection();
    ...
    public Mirror.UnityEventNetworkConnection OnServerAddedPlayer = new Mirror.UnityEventNetworkConnection();
    ...
    public Mirror.UnityEventNetworkConnection OnServerDisconnected = new Mirror.UnityEventNetworkConnection();
    ...
    public override void OnStartServer()
    {
      ...
      onServerOrClientStart?.Invoke();
      LobbyUIManager.SpawnLobbyIcons(NetworkAuthenticator.expectedPlayers);
    ...
    public override void OnStopServer()
    {
      ...
      Debug.Log("OnStopServer() quitting");
      Application.Quit();
    }
