...
const unityContext = new UnityContext({
  loaderUrl: `${process.env.PUBLIC_URL}/unitybuilds/${BUILD_NAME}/Build/${BUILD_NAME}.loader.js`,
  dataUrl: `${process.env.PUBLIC_URL}/unitybuilds/${BUILD_NAME}/Build/${BUILD_NAME}.data`,
  frameworkUrl: `${process.env.PUBLIC_URL}/unitybuilds/${BUILD_NAME}/Build/${BUILD_NAME}.framework.js`,
  codeUrl: `${process.env.PUBLIC_URL}/unitybuilds/${BUILD_NAME}/Build/${BUILD_NAME}.wasm`,
});
